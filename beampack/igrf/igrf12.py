...
igrf12.py version based on igrf12coeffs.txt file is created by EK on 1/24/15
...
if pwd=='':
	file=open('igrf12coeffsORIG.txt')	# open the coefficients textfile
else:
	file=open(pwd+'/igrf12coeffsORIG.txt')	# open the coefficients textfile
